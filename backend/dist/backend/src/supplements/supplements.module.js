...
const supplements_repository_1 = require("./supplements.repository");
...
exports.SupplementsModule = SupplementsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [supplements_service_1.SupplementsService, supplements_repository_1.SupplementsRepository],
        exports: [supplements_service_1.SupplementsService, supplements_repository_1.SupplementsRepository],
    })
], SupplementsModule);
