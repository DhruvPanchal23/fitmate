...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Log daily supplement dosage' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Supplement intake successfully logged.' }),
...
], SupplementsController.prototype, "logSupplement", null);
__decorate([
    (0, common_1.Get)('supplement'),
    (0, swagger_1.ApiOperation)({ summary: 'Get supplement logs for today' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Supplement logs list returned.' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized.' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SupplementsController.prototype, "getSupplementLogs", null);
