...
const water_repository_1 = require("./water.repository");
...
exports.WaterModule = WaterModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [water_service_1.WaterService, water_repository_1.WaterRepository],
        exports: [water_service_1.WaterService, water_repository_1.WaterRepository],
    })
], WaterModule);
