...
export declare class NutritionController {
    ...
    constructor(nutritionService: NutritionService, foodsService: FoodsService, exerciseService: ExerciseService);
    getTodayLogs(req: any): Promise<{
        calories: {
            current: number;
            target: number;
        };
