...
-- CreateIndex
CREATE UNIQUE INDEX "MealScan_mealId_key" ON "MealScan"("mealId");
...
-- AddForeignKey
ALTER TABLE "MealScan" ADD CONSTRAINT "MealScan_mealId_fkey" FOREIGN KEY ("mealId") REFERENCES "Meal"("id") ON DELETE SET NULL ON UPDATE CASCADE;
